      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10">
        ...
        <div className="glass p-6 rounded-2xl flex flex-col items-center justify-center text-center">
          ...
          <ul className="space-y-4 text-slate-300 text-sm">
            ...
            <li className="flex items-center gap-3 justify-center">
              <MapPin className="text-indigo-400" size={18} /> Salé, Morocco
            </li>
          </ul>
          ...
          <p className="mt-8 text-indigo-300 text-sm italic">Always open to freelance and collaboration opportunities 🚀</p>

          {/* QR Code */}
          <QRCodeGenerator url="https://my-portfolio-wrrh.vercel.app/" />
        </div>
      </div>
    </section>
  );
